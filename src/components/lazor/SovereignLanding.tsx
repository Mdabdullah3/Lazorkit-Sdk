        ...
        <div className="relative w-full min-h-screen flex flex-col bg-[#010103] selection:bg-rose-500/30 font-sans">
            ...
            <nav className="relative z-50 w-full max-w-[1600px] mx-auto px-10 py-10 flex justify-between items-center">
                <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-[#ff3e3e] via-white to-[#f9d423] flex items-center justify-center shadow-[0_0_30px_rgba(255,62,62,0.4)] transition-transform group-hover:rotate-[5deg]">
            ...
            <div className="relative z-10 flex-1 flex  lg:flex-row items-center justify-center flex-col-reverse px-6 md:px-20 gap-10 lg:gap-24 max-w-[1600px] mx-auto w-full">
                <div className="flex-1 space-y-10 text-center lg:text-left">
                    ...
                    >
                        ...
                        <h1 className="text-6xl md:text-8xl font-black italic leading-[0.8] tracking-[-0.05em] text-white uppercase">
                            Invisible <br />
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#ff3e3e] via-white to-[#f83a99] drop-shadow-[0_0_30px_rgba(255,62,62,0.2)]">Wallets.</span>
                        </h1>
                ...
                >
                    ...
                    <div className="sovereign-glass rounded-[60px] p-12 md:p-16 relative overflow-hidden border-white/5 shadow-[0_40px_100px_rgba(0,0,0,1)] flex flex-col items-center gap-12">
                        ...
                        <div className="text-center space-y-2">
                            <h2 className="text-2xl font-black italic text-white uppercase tracking-tighter">Handshake Portal</h2>
